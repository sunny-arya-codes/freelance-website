...
async function GET() {
    ...
    try {
        const education = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$education$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            order: 1
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(educationWithImages);
    } catch (error) {
        console.error(error);
...
async function POST(req) {
    ...
    try {
        ...
        const newEducation = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$education$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newEducation, {
            status: 201
        });
    } catch (error) {
        console.error(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__464feb4d._.js.map