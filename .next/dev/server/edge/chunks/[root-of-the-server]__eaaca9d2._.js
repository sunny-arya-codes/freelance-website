...
async function middleware(req) {
    ...
    if (pathname.startsWith('/api/admin') && pathname !== '/api/admin/login') {
        ...
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].verify(token, secret);
